...
class TestProductRoutes(TestCase):
    ...
    def test_update_product_not_found(self):
        """It should return HTTP_404_NOT_FOUND (for update route)"""
        product = {
            "name" : "Hat",
        ...
        response = self.client.put(f"{BASE_URL}/0", json=product)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        data = response.get_json()
        self.assertIn("was not found", data["message"])
    ...
    def test_get_product_by_name(self):
        """It should list product with entered name"""
        products = self._create_products(5)
    ...
    def test_get_product_by_category(self):
        """It should list product with entered category"""
        products = self._create_products(5)
    ...
    def test_get_product_by_availability(self):
        """It should list product with entered availability"""
